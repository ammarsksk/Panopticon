...
def main() -> None:
    ...
    checks = [
        ...
        ("REPO_EMBEDDING_PROVIDER", settings.repo_embedding_provider == "vertex" or not settings.is_production, settings.repo_embedding_provider),
        ("REPO_EMBEDDING_MODEL", bool(settings.repo_embedding_model), settings.repo_embedding_model),
        ("REPO_PGVECTOR_ENABLED", settings.repo_pgvector_enabled or not settings.is_production, str(settings.repo_pgvector_enabled)),
